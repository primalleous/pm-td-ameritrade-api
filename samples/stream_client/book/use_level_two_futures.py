# does not return anything: Service not available or temporary down
...
async def add_book_handler():
    stream_services.add_handler(
        "data", "FUTURES_BOOK", book_handler.data_message_handler
    )
...
async def main():
    ...
    stream_services.level_two_futures(symbols=["/ES"])
