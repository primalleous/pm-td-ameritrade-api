...
from samples.stream_client.example_handlers import level_one_futures_handler
...
async def add_quote_handler():
    stream_services.add_handler(
        "data", "LEVELONE_FUTURES", level_one_futures_handler.data_message_handler
    )
...
async def main():
    ...
    stream_services.level_one_futures(symbols=["/ES"])
