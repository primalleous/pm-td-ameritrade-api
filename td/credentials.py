...
class TdCredentials:
    ...
    def __init__(
        ...
        self.log.info(f"{self.app_name} : credentials init complete")
    ...
    def access_token_expiration_time(self):
        ...
        """
        return TdCredentials.__consumer_apps[self._app_name][
    ...
    def is_access_token_expired(self) -> bool:
        ...
        return (
            self.access_token_expiration_time.timestamp() - 20
    ...
    def is_refresh_token_expired(self) -> bool:
        ...
        return (
            self.refresh_token_expiration_time.timestamp() - 20
        ) < datetime.now().timestamp()
    ...
    def from_token_dict(self, token_dict: dict) -> None:
        ...
        self._refresh_token_expires_in = token_dict.get("refresh_token_expires_in", 0)
    ...
    def grab_authorization_code(self) -> None:
        ...
        payload = {
            "username": self.__login_credentials_dict["username"],
        ...
        # Get the Answer Box
        driver.find_element(
            By.XPATH, "//*[@value='Answer a security question']"
        ).click()
        ...
        driver.find_element(
            By.XPATH, "//*[contains(., 'No, do not trust this device')]"
        ).click()
        # Submit results
        driver.find_element("id", "accept").click()
        ...
        driver.quit()
        self.authorization_code = unquote(new_url.split("code=")[1])
